...
###!!!!! Need to check last 2 numbers of array_name to get the value that was used when generating the arrays
#block_size = 35 
...
for array_name in array_name_list:
    ...
    plt.title('Connected Regions vs. Frame, {0}_{1}'.format(video[:-38], array_name[:6]))
    ...
    plt.xlabel('Frame Number')
    plt.title('Connected Regions (>{0}) vs. Frame, {1}_{2}'.format(large_region_threshold,video[:-38], array_name[:6]))
    ...
    plt.xlabel('Frame Number')
    plt.title('Connected Regions (>{0}) vs. Frame, {1}_{2}'.format(medium_region_threshold,video[:-38], array_name[:6]))
    ...
    plt.xlabel('Frame Number')
    plt.title('Total Size vs. Frame, {0}_{1}'.format(video[:-38], array_name[:6]))
