...
video = "DsRed2-HeLa_4_5_LLO2 (Converted).mov/"

array_name_list = ["hull_1_segmentation_7_21_25.npy", "hull_2_segmentation_7_21_25.npy"]
...
for array_name in array_name_list:
    ...
    plt.plot(x, np.array(num_labels_list), linewidth=0.6)
    ...
    plt.plot(x, np.array(large_regions_list), linewidth=0.6)
    ...
    plt.plot(x, np.array(medium_regions_list), linewidth=0.6)
    ...
    plt.plot(x, np.array(total_size_list), color = 'g', linewidth=0.6)
